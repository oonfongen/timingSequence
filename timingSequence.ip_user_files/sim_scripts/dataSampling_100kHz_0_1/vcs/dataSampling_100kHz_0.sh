...
#
# Script generated by Vivado on Sun Apr 14 12:59:59 +08 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dataSampling_100kHz_0.sh
...
#
# Usage        : dataSampling_100kHz_0.sh
#                dataSampling_100kHz_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dataSampling_100kHz_0.sh [-reset_run]
#                dataSampling_100kHz_0.sh [-reset_log]
#                dataSampling_100kHz_0.sh [-help]
#
...
#                script (type 'dataSampling_100kHz_0.sh -help' for more information).
#
...
# script info
echo -e "dataSampling_100kHz_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dataSampling_100kHz_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dataSampling_100kHz_0 xil_defaultlib.glbl -o dataSampling_100kHz_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dataSampling_100kHz_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/fongen/Xilinx/tutorial/laserLockingSimulator/laserLockingSimulator.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key dataSampling_100kHz_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dataSampling_100kHz_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dataSampling_100kHz_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dataSampling_100kHz_0.sh [-help]\n\
Usage: dataSampling_100kHz_0.sh [-step]\n\
Usage: dataSampling_100kHz_0.sh [-lib_map_path]\n\
Usage: dataSampling_100kHz_0.sh [-reset_run]\n\
Usage: dataSampling_100kHz_0.sh [-reset_log]\n\
Usage: dataSampling_100kHz_0.sh [-keep_index]\n\
Usage: dataSampling_100kHz_0.sh [-noclean_files]\n\n\
