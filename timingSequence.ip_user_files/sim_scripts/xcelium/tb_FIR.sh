...
#
# Script generated by Vivado on Thu Apr 04 19:39:12 +08 2024
...
#
# Usage        : tb_FIR.sh
#                tb_FIR.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_FIR.sh [-reset_run]
#                tb_FIR.sh [-reset_log]
#                tb_FIR.sh [-help]
#
...
#                script (type 'tb_FIR.sh -help' for more information).
#
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_FIR.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_17 $xmvlog_opts -sv +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_1 $xmvlog_opts +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/10ab/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_29 $xmvlog_opts +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ff9f/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_data_fifo_v2_1_28 $xmvlog_opts +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_30 $xmvlog_opts +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_protocol_converter_v2_1_29 $xmvlog_opts +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_clock_converter_v2_1_28 $xmvlog_opts +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/769c/hdl/axi_clock_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work blk_mem_gen_v8_4_7 $xmvlog_opts +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/3c0c/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_dwidth_converter_v2_1_29 $xmvlog_opts +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xlconcat_v2_1_5 $xmvlog_opts +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../FIR_tutorial/FIR_tutorial.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/home/fongen/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.tb_FIR xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.tb_FIR -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/fongen/data/Xilinx/tutorial/FIR_400kHz/FIR_400kHz.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log tb_FIR_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_FIR.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_FIR.sh [-help]\n\
Usage: tb_FIR.sh [-step]\n\
Usage: tb_FIR.sh [-lib_map_path]\n\
Usage: tb_FIR.sh [-reset_run]\n\
Usage: tb_FIR.sh [-reset_log]\n\
Usage: tb_FIR.sh [-keep_index]\n\
Usage: tb_FIR.sh [-noclean_files]\n\n\
